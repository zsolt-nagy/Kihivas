    ...
    return {
        ...
        skillList: [
            ...
            },
            {
                ...
                description: "Minnél jobban kitanuljuk a gyógyfőzetek készítésének tudományát, annál több gyógyfőzetet tudunk értékesíteni aranyért cserébe.",
                amount: 0,
                price: 750,
        ...
        employeeList: [
            ...
            {
                employeeName: 'Gyógyfőzet keszítő',
            ...
            },
            {
                ...
                description: "Tanulókat képez ki szerződéses munkatárként. Szabadidejében alkímiával foglalkozik.",
                amount: 0,
                price: 50000,
...
function handleSkillsClicked(event) {
    let clcikIndex = event.target.dataset.index;
    if (typeof clcikIndex !== 'undefined') {
        let clickedSkill = skillList[clcikIndex];
...
function handleEmployeeClicked(event) {
    let clcikIndex = event.target.dataset.index;
    if (typeof clcikIndex !== 'undefined') {
        let clickedEmployee = employeeList[clcikIndex];
...
function getClickingAreaTemplate() {
    return `
        ...
        <img 
            src="./assets/300x300 gold-coin.png" 
            alt="Arany klikkelő" 
